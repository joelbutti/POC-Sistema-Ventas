...
namespace POC_Sistema_Ventas.Forms.Productos
{
    public partial class FrmEditarProducto : Form
    {
        ...
        public FrmEditarProducto(Producto prod)
        {
        ...
        private void BtnAceptar_Click(object sender, EventArgs e)
        {
            ...
            nuevo.Id = productoSeleccionado.Id;
            nuevo.Categoria = conexion.BuscarCategoria(nuevo.CategoriaId);
            conexion.ModificarProductos(nuevo);
        ...
        private void FrmEditarProducto_Load(object sender, EventArgs e)
        {
            ...
            TbNombre.Text = productoSeleccionado.Nombre;
            TbDescripcion.Text = productoSeleccionado.Descripcion;
            TbStock.Text = productoSeleccionado.Stock.ToString();
            TbPrecio.Text = productoSeleccionado.Precio.ToString();
            CbCategoria.Text = productoSeleccionado.Categoria.Nombre.ToString();
        }
    }
}
